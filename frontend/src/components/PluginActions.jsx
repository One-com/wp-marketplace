...
export default function PluginActions({ plugin }) {
  ...
  const shouldShowSelectButton =
    isOnecomBrand && isSpecialPlugin && !plugin.installed && pluginSubscriptionStatus === false;
  ...
  return (
    <div className="plugin-actions gv-mt-md">
      {shouldShowSkeleton ? (
        ...
        plugin.activated ? (
          <button type="button" className="gv-button gv-button-primary" onClick={handleManage}>
