...
export default function FeaturedCarousel({ loading = false }) {
  ...
  return (
    <section className="gv-featured-carousel gv-w-full">
      <div className="gv-carousel-header gv-mb-lg gv-tab-mt-md gv-max-mob-mt-0">
        <h5 className="gv-title gv-heading-sm gv-recommended-heading">
              ...
              >
                ...
                >
                  <div className="gv-content  gv-stack-space-lg gv-text-sm gv-flex gv-flex-col gv-items-start">
                    ...
                    <h5 className="gv-title gv-header-sm">{title}</h5>
                    <p
      ...
      {totalSlides > slidesPerView && (
        <div className="gv-carousel-nav-wrapper gv-flex gv-justify-center gv-align-center gv-mt-sm gv-gap-fluid">
          <button
          ...
          <div className="gv-carousel-dots gv-flex-wrap gv-items-center gv-flex gv-justify-center  gv-gap-sm">
