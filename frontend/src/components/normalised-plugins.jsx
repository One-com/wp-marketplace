export function normalizePlugins(rawResponse) {
  ...
  const normalized = items.map((plugin) => {
    ...
    return {
      ...
      activeInstalls: plugin?.activeInstalls ?? null,
      pluginLastUpdated: plugin?.pluginLastUpdated || null,
      freeTrial: plugin?.freeTrial || null,
      rating: plugin?.rating ?? null,
      ratingCount: plugin?.ratingCount ?? null,
      requiresDomain: plugin?.requiresDomain ?? false,
      requiresWpVersion: plugin?.requiresWpVersion || "",
      requiresPhpVersion: plugin?.requiresPhpVersion || "",
