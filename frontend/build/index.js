...
function FeaturedCarousel() {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
    className: "gv-featured-carousel gv-w-full gv-mt-fluid"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony import */ var _context_MarketplaceContext__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../context/MarketplaceContext */ "./src/context/MarketplaceContext.jsx");
/* harmony import */ var _utils_priceFormatter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/priceFormatter */ "./src/utils/priceFormatter.js");
...
function Marketplace() {
  ...
  } = (0,_context_MarketplaceContext__WEBPACK_IMPORTED_MODULE_6__.useMarketplace)();
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    async function fetchPlugins() {
      try {
        ...
        if (isOnecomBrand) {
          const specialPlugins = normalized.filter(p => p.slug === "wp-rocket" || p.slug === "rank-math-pro");
  ...
  }, " ", (0,_utils_priceFormatter__WEBPACK_IMPORTED_MODULE_7__.formatPluginPrice)(plugin), " ")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
function PluginActions({
  ...
  }, pluginInAction[plugin.slug] ? marketplaceConfig?.labels?.activating || 'Activating...' : plugin.textKeys?.activateButton || 'Activate') : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    className: "gv-button gv-button-primary",
    disabled: pluginInAction[plugin.slug],
    onClick: () => handleClick("install")
  }, pluginInAction[plugin.slug] ? marketplaceConfig?.labels?.installing || 'Installing...' : plugin.textKeys?.installButton || 'Install'));
}
    ...
    style: {
      ...
      display: 'block'
                ...
                @media (max-width: 768px) {
                    .gv-product-header .gv-left-banner {
                        display: none !important;
                    }
                    .gv-product-header {
                        padding: 1.5rem 1rem !important;
                    }
                    .gv-product-header h1 {
                        font-size: 1.75rem !important;
                    }
                }
                @media (max-width: 480px) {
                    .gv-product-header .gv-right-banner {
                        max-width: 150px;
                    }
                    .gv-product-header h1 {
...
function ProductDetail({
  ...
  const content = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "gv-title"
  }, plugin.textKeys?.featureOverviewHeading || 'Key features'))), keyFeatures.map((f, i) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gv-table-row",
    role: "row",
    key: i
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, plugin.textKeys?.benefitHeading || 'Key benefits'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
    ...
    className: "gv-title gv-text-bold gv-text-lg"
  }, plugin.textKeys?.featureOverviewHeading || 'Core features overview'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
function ProductDetailRankMath({
  ...
  const content = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    type: "button",
    className: "gv-button gv-button-secondary"
  }, freePlugin?.textKeys?.installButton || 'Install'))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gv-product",
    role: "columnheader"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gv-content"
    ...
    className: "gv-title"
  }, freePlugin?.textKeys?.featureOverviewHeading || 'Key features')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gv-cell",
    role: "cell"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", {
    className: "gv-title"
  }, proPlugin?.textKeys?.featureOverviewHeading || 'Key features'))), keyFeatures.map((f, i) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "gv-table-row",
    role: "row",
    key: i
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
